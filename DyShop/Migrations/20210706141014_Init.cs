        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeliveryTitle = table.Column<string>(type: "text", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_ClientAddresses_BillingAddressId",
                        column: x => x.BillingAddressId,
                        principalTable: "ClientAddresses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Orders_ClientAddresses_DeliveryAddressId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Products_ProductCategories_MainCategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductCategoryRelations", x => new { x.ProductId, x.ProductCategoryId });
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                table: "Payments",
                columns: new[] { "Id", "Price", "Title" },
                values: new object[] { 1, 0f, "Bankovní převod" });
